  ...
  defp screens_text do
    Enum.join(
      [
        ...
        "",
        Status.render(:cyan, "Ruminations [t]") <> "  — Rumination pipeline list.",
        "  Shows name, status, trigger type, and synapse count",
        "  for every rumination in the system.",
        "",
  ...
  defp data_model_text do
    Enum.join(
      [
        ...
        "Ruminations  — structured pipelines (formerly Thoughts)",
        "Synapses     — pipeline steps (formerly Rumination Steps)",
