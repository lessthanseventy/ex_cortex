defmodule ExCortexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ExCortexWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ExCortexWeb.Gettext, "errors", msg, opts)
    # end
