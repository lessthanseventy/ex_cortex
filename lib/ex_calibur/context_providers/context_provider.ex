defmodule ExCalibur.ContextProviders.ContextProvider do
  @moduledoc """
  ...
  defp module_for("static"), do: Module.concat([ExCalibur, ContextProviders, Static])

  defp module_for("quest_history"), do: Module.concat([ExCalibur, ContextProviders, QuestHistory])
