defmodule ExCalibur.ContextProviders.AppTelemetry do
  @moduledoc """
  Injects a structured summary of recent app activity into the prompt.

  Covers: quest run outcomes, circuit breaker trips, LLM errors, deduplicated
  ...
  def build(config, _quest, _input) do
    ...
    summary = ExCalibur.AppTelemetry.recent(window_hours: window_hours)
