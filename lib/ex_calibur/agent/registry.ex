defmodule ExCalibur.Agent.Registry do
  @moduledoc """
  Unified registry over code modules and DB-defined member resources.
  ...
  defp load_db_resources do
    if Application.get_env(:ex_calibur, :sql_sandbox, false) do
      {:ok, %{}}
    else
      try do
        resources =
          from(r in Member, where: r.status != "archived")
          |> ExCalibur.Repo.all()
