defmodule ExCalibur.Charters.PerformanceAudit do
  @moduledoc """
  Performance audit pipeline charter.
  ...
  def quest_definitions do
    [
      ...
      %{
        ...
        description: "Comprehensive performance analysis by all members reaching consensus",
        status: "active",
        trigger: "manual",
        schedule: nil,
  ...
  def campaign_definitions do
    [
      %{
        ...
        schedule: "@daily",
        steps: [
          %{"quest_name" => "Performance Quick Scan", "flow" => "always"},
          %{"quest_name" => "Full Performance Audit", "flow" => "on_flag"},
          %{"quest_name" => "File Performance Regression", "flow" => "on_flag"},
          %{"quest_name" => "Post Performance Alert", "flow" => "on_flag"},
          %{"quest_name" => "Performance Baseline Memory", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
