defmodule ExCalibur.Charters.RiskAssessment do
  @moduledoc """
  Risk assessment pipeline charter.
  ...
  def quest_definitions do
    [
      ...
      %{
        ...
        description: "Comprehensive risk analysis by all members reaching consensus",
        status: "active",
        trigger: "manual",
        schedule: nil,
  ...
  def campaign_definitions do
    [
      %{
        ...
        schedule: "@daily",
        steps: [
          %{"quest_name" => "Risk Quick Scan", "flow" => "always"},
          %{"quest_name" => "Full Risk Assessment", "flow" => "on_flag"},
          %{"quest_name" => "Page On High Risk", "flow" => "on_flag"},
          %{"quest_name" => "Post Risk Summary", "flow" => "on_flag"},
          %{"quest_name" => "Risk Pattern Memory", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
