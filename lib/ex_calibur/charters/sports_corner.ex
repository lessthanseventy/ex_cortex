defmodule ExCalibur.Charters.SportsCorner do
  @moduledoc """
  Sports Corner guild charter.

  Daily sports digest — scores, storylines, and what it all means.
  Builds a narrative arc over time. Uses builtin members: sports-anchor,
  ...
  def metadata do
    members = [
      BuiltinMember.get("sports-anchor"),
  ...
  def campaign_definitions do
    [
      %{
        ...
        schedule: nil,
        steps: [
          %{"quest_name" => "Daily Sports Digest", "flow" => "always"},
          %{"quest_name" => "Weekend Roundup", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
