defmodule ExCortex.Neuroplasticity.Seed do
  @moduledoc "Seeds the self-improvement pipeline — called when Dev Team pathway is installed."
  ...
  defp create_steps do
    step_attrs = [
      %{
        name: "SI: PM Triage",
        description: """
        You are the Project Manager for the ExCortex self-improvement pipeline.
      ...
      %{
        ...
        description: """
        You are the Code Reviewer for the ExCortex self-improvement pipeline.
      ...
      %{
        name: "SI: QA",
        description: """
        You are the QA reviewer for the ExCortex self-improvement pipeline.
  ...
  defp create_opportunity_scan_step do
    Thoughts.create_synapse(%{
      ...
      Product value — NOT code quality. What should ExCortex be able to do that it currently
      ...
      loop_tools: [],
      context_providers: [
        %{"type" => "memory", "tags" => ["project", "self-improvement", "pipeline"], "limit" => 3, "sort" => "top"},
        %{
          "type" => "file_reader",
          "files" => [
  ...
  @lore_entries [
    %{
      ...
      importance: 5,
      body: """
      # ExCortex: What This Project Is

      ExCortex is a **Phoenix LiveView web application** for AI agent orchestration and self-improvement.
      ...
      - `ExCortex.Tools.*` — tool implementations (run_sandbox, create_github_issue, etc.)
      - `ExCortex.Pathways.*` — pre-built cluster definitions
      - `ExCortex.Neuroplasticity.*` — SI pipeline seeding

      ## What ExCortex is NOT
    ...
    %{
      ...
      *Authoritative guidance on modern Elixir testing for this codebase.*
      ...
      defmodule MyRepoTest do
        use ExCortex.DataCase, async: true  # wraps in rolled-back transaction
      end
      ```
    ...
    %{
      title: "ExCortex: Working Tree Noise",
      tags: ["project", "worktree", "git", "snapshots", "noise"],
      importance: 4,
      body: """
      # ExCortex: Working Tree Noise
    ...
    %{
      title: "ExCortex: Valid Sandbox Commands",
      tags: ["sandbox", "commands", "tools", "run_sandbox"],
      importance: 5,
      body: """
      # ExCortex: Valid Sandbox Commands
      ...
      ```
      mix test
      mix test test/ex_cortex/board_test.exs
    ...
    %{
      ...
      **Step 1: SI: Codebase Health Scan** (Code Auditor)
      ...
      - Key source files (impulse_runner, runner, ollama) are also pre-injected
      ...
      **Step 2: SI: Feature & Opportunity Scan** (Product Analyst)
      - Context providers inject memory engrams (project identity) and 4 key source files
    ...
    %{
      title: "ExCortex: Available LLM Models",
      tags: ["models", "ollama", "llm", "fallback", "performance"],
      importance: 4,
      body: """
      # ExCortex: Available LLM Models
