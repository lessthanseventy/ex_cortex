defmodule ExCortex.Neurons.Builtin do
  @moduledoc false
  defstruct [:id, :name, :description, :category, :system_prompt, :ranks, :lobe]
  ...
  def wildcards do
    [
      # --- Freeform neurons (designed for output_type: "freeform" thoughts) ---
      ...
      %__MODULE__{
        ...
        voice — as though recording events for the cluster archives. Write in past
      ...
      # --- Verdict neurons with personality ---
