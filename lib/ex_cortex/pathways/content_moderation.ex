defmodule ExCortex.Pathways.ContentModeration do
  @moduledoc """
  Content moderation pipeline pathway.
  ...
  def synapse_definitions do
    [
      %{
        ...
        description: "Quick automated content safety check by apprentice neurons",
        status: "active",
        trigger: "scheduled",
        schedule: "@hourly",
        ...
        context_providers: [
          ...
          %{"type" => "memory", "tags" => ["moderation"], "limit" => 3, "sort" => "newest"}
        ],
        escalate: true,
      ...
      %{
        ...
        description: "Comprehensive moderation review by all neurons reaching consensus",
        status: "active",
        trigger: "manual",
        schedule: nil,
      ...
      %{
        ...
        This helps the cluster stay consistent over time.
        """,
        status: "active",
        trigger: "manual",
        schedule: nil,
  ...
  def rumination_definitions do
    [
      %{
        ...
        schedule: "@hourly",
        steps: [
          %{"thought_name" => "Content Safety Scan", "flow" => "always"},
          %{"thought_name" => "Full Content Review", "flow" => "on_flag"},
          %{"thought_name" => "Escalate Moderation Alert", "flow" => "on_flag"},
          %{"thought_name" => "Moderation Edge Case Log", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
