defmodule ExCortex.Pathways.ContractReview do
  @moduledoc """
  Contract review pipeline pathway.
  ...
  def synapse_definitions do
    [
      %{
        ...
        description: "Quick automated contract risk analysis by apprentice neurons",
        status: "active",
        trigger: "scheduled",
        schedule: "@hourly",
      ...
      %{
        ...
        description: "Comprehensive contract analysis by all neurons reaching consensus",
        status: "active",
        trigger: "manual",
        schedule: nil,
  ...
  def rumination_definitions do
    [
      %{
        ...
        schedule: "@daily",
        steps: [
          %{"thought_name" => "Contract Risk Scan", "flow" => "always"},
          %{"thought_name" => "Full Contract Review", "flow" => "on_flag"},
          %{"thought_name" => "Email Contract Risk Summary", "flow" => "on_flag"},
          %{"thought_name" => "Contract Knowledge Memory", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
