defmodule ExCortex.Pathways.QualityCollective do
  @moduledoc """
  Frontend quality and accessibility review cluster pathway.

  Uses builtin neurons: accessibility-auditor, frontend-reviewer,
  ...
  def metadata do
    neurons = [
      Builtin.get("accessibility-auditor"),
      Builtin.get("frontend-reviewer"),
      Builtin.get("evidence-collector"),
      Builtin.get("the-nitpicker")
    ]
  ...
  def synapse_definitions do
    [
      %{
        ...
        description: "Quick automated accessibility scan by apprentice neurons",
        status: "active",
        trigger: "scheduled",
        schedule: "@hourly",
        ...
        source_ids: [],
        context_providers: [
          %{"type" => "memory", "tags" => ["a11y"], "limit" => 3, "sort" => "importance"}
        ],
        escalate: true,
      ...
      %{
        ...
        description: "Comprehensive quality review by all neurons reaching consensus",
        status: "active",
        trigger: "manual",
        schedule: nil,
  ...
  def rumination_definitions do
    [
      %{
        ...
        schedule: "@daily",
        steps: [
          %{"thought_name" => "A11y Quick Scan", "flow" => "always"},
          %{"thought_name" => "Full Quality Review", "flow" => "on_flag"},
          %{"thought_name" => "Quality Findings Log", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
