defmodule ExCortex.Pathways.CultureDesk do
  @moduledoc """
  Culture Desk cluster pathway.

  Entertainment, music, film, culture. The tabloid voice meets the historian's
  memory. Uses builtin neurons: the-tabloid, the-historian, the-poet, brand-guardian.
  """
  ...
  def campaign_definitions do
    [
      %{
        ...
        schedule: nil,
        steps: [
          %{"thought_name" => "Culture Brief", "flow" => "always"},
          %{"thought_name" => "Weekly Arts Roundup", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
