defmodule ExCortex.Pathways.IncidentTriage do
  @moduledoc """
  Incident triage pipeline pathway.
  ...
  def synapse_definitions do
    [
      %{
        ...
        description: "Quick automated incident severity assessment by apprentice neurons",
        status: "active",
        trigger: "scheduled",
        schedule: "@hourly",
      ...
      %{
        ...
        description: "Comprehensive incident triage by all neurons reaching consensus",
        status: "active",
        trigger: "manual",
        schedule: nil,
