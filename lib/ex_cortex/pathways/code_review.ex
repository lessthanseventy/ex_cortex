defmodule ExCortex.Pathways.CodeReview do
  @moduledoc """
  Code review pipeline pathway.
  ...
  def synapse_definitions do
    [
      %{
        ...
        description: "Quick automated code quality check by apprentice neurons",
        status: "active",
        trigger: "scheduled",
        schedule: "@hourly",
        roster: [%{"who" => "apprentice", "when" => "on_trigger", "how" => "solo"}],
        source_ids: [],
        context_providers: [%{"type" => "memory", "tags" => ["code-review"], "limit" => 3, "sort" => "importance"}],
        escalate: true,
        escalate_threshold: 0.6
      },
      %{
        name: "Full Code Review",
        description: "Comprehensive review by all neurons reaching consensus",
        status: "active",
        trigger: "manual",
        schedule: nil,
      ...
      %{
        ...
        context_providers: [%{"type" => "memory", "tags" => ["code-review"], "limit" => 5, "sort" => "importance"}],
        loop_mode: "reflect",
        loop_tools: ["query_memory", "search_github", "search_obsidian"]
      },
      %{
  ...
  def rumination_definitions do
    [
      %{
        ...
        schedule: "@daily",
        steps: [
          %{"thought_name" => "Code Quality Scan", "flow" => "always"},
          %{"thought_name" => "Full Code Review", "flow" => "on_flag"},
          %{"thought_name" => "File Code Review Issue", "flow" => "on_flag"},
          %{"thought_name" => "Post Code Review Summary", "flow" => "on_flag"},
          %{"thought_name" => "Code Pattern Memory", "flow" => "always"}
        ],
        source_ids: []
      }
    ]
