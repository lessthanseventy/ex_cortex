defmodule ExCortex.Integration.EverydayCouncilFlowTest do
  use ExCortex.DataCase, async: false

  alias ExCortex.Pathways.EverydayCouncil
  alias ExCortex.Senses.Reflex

  test "resource_definitions returns valid neuron configs" do
