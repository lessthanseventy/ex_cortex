...
**Files:**
- `lib/ex_cellence_server_web/live/library_live.ex` (new)
- `test/ex_cellence_server_web/live/library_live_test.exs` (new)
...
**Files:**
- `lib/ex_cellence_server_web/live/stacks_live.ex` (rename from sources_live.ex)
- `test/ex_cellence_server_web/live/stacks_live_test.exs` (rename from sources_live_test.exs)
