...
**Tech Stack:** Phoenix LiveView, Ecto, ExCortex.QuestRunner (from escalation plan).
...
**Files:**
- Create: `lib/ex_cortex/context_provider.ex`
- Create: `lib/ex_cortex/context_providers/static.ex`
- Create: `test/ex_cortex/context_providers/static_test.exs`

**Step 1: Write the failing test**

```elixir
# test/ex_cortex/context_providers/static_test.exs
defmodule ExCortex.ContextProviders.StaticTest do
  use ExUnit.Case, async: true

  alias ExCortex.ContextProviders.Static
...
```bash
cd /home/andrew/projects/ex_cortex && mix test test/ex_cortex/context_providers/static_test.exs
```
...
```elixir
# lib/ex_cortex/context_provider.ex
defmodule ExCortex.ContextProvider do
  @moduledoc """
  ...
  @builtin_providers %{
    "static" => ExCortex.ContextProviders.Static,
    "quest_history" => ExCortex.ContextProviders.QuestHistory,
    "member_stats" => ExCortex.ContextProviders.MemberStats
  }
  ...
  """
  def resolve(type) do
    custom = Application.get_env(:ex_cortex, :context_providers, [])
...
```bash
mix test test/ex_cortex/context_providers/static_test.exs
```
...
```bash
git add lib/ex_cortex/context_provider.ex lib/ex_cortex/context_providers/static.ex test/ex_cortex/context_providers/static_test.exs
...
**Files:**
- Create: `lib/ex_cortex/context_providers/quest_history.ex`
- Create: `test/ex_cortex/context_providers/quest_history_test.exs`

**Step 1: Write the failing test**

```elixir
# test/ex_cortex/context_providers/quest_history_test.exs
defmodule ExCortex.ContextProviders.QuestHistoryTest do
  use ExCortex.DataCase, async: true

  alias ExCortex.ContextProviders.QuestHistory
...
```bash
mix test test/ex_cortex/context_providers/quest_history_test.exs
```
...
```elixir
# lib/ex_cortex/context_providers/quest_history.ex
defmodule ExCortex.ContextProviders.QuestHistory do
...
```bash
git add lib/ex_cortex/context_providers/quest_history.ex test/ex_cortex/context_providers/quest_history_test.exs
...
**Files:**
- Create: `lib/ex_cortex/context_providers/member_stats.ex`
- Create: `test/ex_cortex/context_providers/member_stats_test.exs`

**Step 1: Write the failing test**

```elixir
# test/ex_cortex/context_providers/member_stats_test.exs
defmodule ExCortex.ContextProviders.MemberStatsTest do
  use ExCortex.DataCase, async: true

  alias ExCortex.ContextProviders.MemberStats
  alias ExCortex.Repo
...
```bash
mix test test/ex_cortex/context_providers/member_stats_test.exs
```
...
```elixir
# lib/ex_cortex/context_providers/member_stats.ex
defmodule ExCortex.ContextProviders.MemberStats do
...
```bash
git add lib/ex_cortex/context_providers/member_stats.ex test/ex_cortex/context_providers/member_stats_test.exs
...
def run(quest, input, opts \\ []) do
  ...
  context_preamble =
    ExCortex.ContextProvider.assemble(
...
In `lib/ex_cortex/quests/quest.ex`, add field:
...
```bash
git add lib/ex_cortex/quest_runner.ex lib/ex_cortex/quests/quest.ex priv/repo/migrations/20260308240000_add_context_providers_to_quests.exs
