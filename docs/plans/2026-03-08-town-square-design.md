...
```elixir
defmodule ExCortex.Members.Member do
...
- Member catalogue in `lib/ex_cortex/members/member.ex`
- Town Square LiveView in `lib/ex_cortex_web/live/town_square_live.ex`
